...
pool_volume = int(input("Enter pool volume in gallons: "))
filter_capacity = int(input("Enter filter capacity in gallons: "))
...
def backwash():
    ...
    print("Current water level: {} gallons".format(current_water_level))
...
def waste():
    ...
    current_water_level -= int(input("Enter amount of water to drain in gallons: "))
    print("Current water level: {} gallons".format(current_water_level))
